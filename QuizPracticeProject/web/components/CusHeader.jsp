        ...
        <div class="header_content">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-lg" aria-labelledby="dropdownMenuButton">
                    ...
                    <li class="d-flex" ><img src="img/profile.png" style="width: 20px" alt=""><button type="button" class="dropdown-item" data-target="#PopUpProfile" data-toggle="modal">Profile</button></li>
