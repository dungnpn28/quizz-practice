...
public class Lesson {
    ...
    public Lesson(int id, int subject_id, int topic_id, String name, int type_id, int order, String video_link, String html_content, String lesson_type_name, String lesson_topic_name) {
        this.id = id;
        this.subject_id = subject_id;
        this.topic_id = topic_id;
        this.name = name;
